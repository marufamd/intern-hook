...
An automated hourly Discord notification system that fetches the latest software engineering internships in the United States and Canada using the [JobSpy](https://github.com/cullenwatson/JobSpy) library.

## Features

-   **Hourly Updates**: Fetches and sends new internships posted within the last hour.
-   **US & Canada Coverage**: Aggregates results from both countries.
-   **Multi-Source**: Pulls from LinkedIn, Indeed, Glassdoor, Google Jobs, and ZipRecruiter.
